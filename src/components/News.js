...
export class News extends Component {
  ...
  async updateNews() {
    ...
    if (this.props.category === "") {
      //when there is query
      url = `https://newsapi.org/v2/top-headlines?q=${this.props.query}&apiKey=${this.props.apikey}&page=${this.state.pgno}&pageSize=${this.props.pagesize}`;
    } else {
      //when there is category
      url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.apikey}&page=${this.state.pgno}&pageSize=${this.props.pagesize}`;
    }
